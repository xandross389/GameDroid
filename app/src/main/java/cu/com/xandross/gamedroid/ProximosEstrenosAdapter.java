...
/**
 * Created by XandrOSS on 10/04/2016.
 */
public class ProximosEstrenosAdapter extends RecyclerView.Adapter<ProximosEstrenosAdapter.GamesViewHolder> {
    private Context mContext;
    private ArrayList<Game> datos;
    private static GameItemClickListener gameItemClickListener;

    public ProximosEstrenosAdapter(Context context, ArrayList<Game> datos) {
        this.datos = datos;
        mContext = context;
    }
...
//            imgGameFavorite.setOnClickListener(new View.OnClickListener() {
//                @Override
//                public void onClick(View v) {
//                    //  Snackbar.make(v, "Favorito!!!", Snackbar.LENGTH_LONG).show();
//                    Toast.makeText(vContext, "Favorito!!1", Toast.LENGTH_LONG).show();
//
//                    try {
//
